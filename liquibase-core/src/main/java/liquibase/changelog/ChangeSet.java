...
public class ChangeSet implements Conditional {
    ...
    private StateConditional stateConditional;
    ...
    public StateConditional getStateConditional() {
        return stateConditional;
    }

    public void setStateConditional(StateConditional stateConditional) {
        this.stateConditional = stateConditional;
    }
}
